...
public class ClientApplication extends JFrame {
	...
	private JTextArea chttingContent;
	...
	public ClientApplication() {
		...
		usernameField.setBounds(62, 483, 319, 38);
		...
		enterButton.setBounds(62, 531, 319, 38);
		...
		roomExitButton.setBounds(340, 0, 114, 99);
		roomPanel.add(roomExitButton);

		JScrollPane chattingContentScroll = new JScrollPane();
		chattingContentScroll.setBounds(0, 98, 454, 590);
		roomPanel.add(chattingContentScroll);

		chttingContent = new JTextArea();
		chattingContentScroll.setViewportView(chttingContent);
		chttingContent.setEditable(false);
		...
		sendMessageField.setBounds(0, 688, 370, 63);
		...
		sendButton.setBounds(370, 688, 84, 63);
